...
class Tablero:
        ...
        for fila in range(FILAS):
            for columna in range(COLUMNAS):
                ...
                if (resaltar.__contains__([fila, columna])):
                    pygame.draw.rect(ventana, COLOR_RESALTAR, (columna *
                                     ANCHO_CELDA, fila * ALTO_CELDA, ANCHO_CELDA, ALTO_CELDA))
                    pygame.draw.rect(ventana, COLOR_BORDE_CELDA, (columna *
                                     ANCHO_CELDA, fila * ALTO_CELDA, ANCHO_CELDA, ALTO_CELDA), 1)
                elif (self.matriz[fila][columna] > 0):
                    pygame.draw.rect(ventana, COLOR_PUNTUACION, (columna *
                                     ANCHO_CELDA, fila * ALTO_CELDA, ANCHO_CELDA, ALTO_CELDA))
                    pygame.draw.rect(ventana, COLOR_BORDE_CELDA, (columna *
                                     ANCHO_CELDA, fila * ALTO_CELDA, ANCHO_CELDA, ALTO_CELDA), 1)
                else:
                    pygame.draw.rect(
                        ventana, COLOR_CELDA, (columna * ANCHO_CELDA, fila * ALTO_CELDA, ANCHO_CELDA, ALTO_CELDA))
                    pygame.draw.rect(ventana, COLOR_BORDE_CELDA, (columna *
                                     ANCHO_CELDA, fila * ALTO_CELDA, ANCHO_CELDA, ALTO_CELDA), 1)
                ...
                if (self.matriz[fila][columna] > 0):
                    ...
                    ventana.blit(texto, (columna * ANCHO_CELDA +
                                 5, fila * ALTO_CELDA + 5))
                ...
                if fila == self.caballo_blanco_y and columna == self.caballo_blanco_x:
                    ...
                    ventana.blit(self.imagen_caballo_blanco,
                ...
                if fila == self.caballo_negro_y and columna == self.caballo_negro_x:
                    ...
                    ventana.blit(self.imagen_caballo_negro,
                                 (columna * ANCHO_CELDA, fila * ALTO_CELDA))
    ...
    #     if (cantidadPuntuacion == 0):
    #         if (self.puntuacion_caballo_blanco > self.puntuacion_caballo_negro):
    #             return "Ha ganado el caballo blanco"
    #         elif (self.puntuacion_caballo_negro > self.puntuacion_caballo_blanco):
    #             return "Ha ganado el caballo negro"
    #         else:
    #             return "Han quedado en empate"
    #     else:
    #         return None
    ...
    def mover_caballo(self, x, y, posiciones):
        ...
        limpiar_consola()
        print("Puntuación caballo blanco: " +
              str(self.puntuacion_caballo_blanco))
        print("Puntuación caballo negro: " +
              str(self.puntuacion_caballo_negro))
